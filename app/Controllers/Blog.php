...
class Blog extends BaseController
{
    ...
    public function view($id){
        echo view('layout/headerblogview');
        $model = new ModelsBlog();
    ...
    public function simpan(){
        ...
        return redirect()->to('/tampilberita')->with('berhasil', 'Data Berhasil di Simpan');
    }
    ...
    public function edit(){
        ...
        return redirect()->to('/tampilberita')->with('berhasil', 'Data Berhasil di Ubah');
    ...
    public function hapus($id){
        ...
        $path = '../public/assets/images/';
        @unlink($path.$gambar);
        return redirect()->to('/tampilberita')->with('berhasil', 'Data Berhasil di Hapus');
    }
